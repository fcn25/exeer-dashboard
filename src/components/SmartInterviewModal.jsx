...
function InterviewResultContent({ content }) {
  ...
  return (
    <div
      dir="rtl"
      lang="ar"
      className="max-h-72 overflow-y-auto rounded-2xl border border-exeer-border bg-white p-4 text-right text-sm text-slate-800 dark:bg-[#1e293b] dark:text-slate-100"
    >
