...
export function mapRowToEmployeeForm(row) {
  ...
  return {
    ...
    iqama_expiry_date: toDateInputValue(row.iqama_expiry_date),
    work_permit_expiry_date: toDateInputValue(row.work_permit_expiry_date),
    probation_end_date: toDateInputValue(row.probation_end_date),
