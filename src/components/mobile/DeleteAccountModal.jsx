...
export default function DeleteAccountModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="w-full max-w-md rounded-md border border-red-200 bg-white p-6 shadow-none"
        ...
        {step === 1 ? (
          ...
          <>
            ...
            <input
              ...
              spellCheck={false}
              placeholder="DELETE"
              className="mt-4 w-full rounded-md border border-gray-200 px-4 py-3 text-sm text-slate-900 outline-none ring-red-200 focus:border-red-400 focus:ring-2 disabled:opacity-50"
            />
