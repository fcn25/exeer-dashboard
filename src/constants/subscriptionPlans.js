...
export const PAID_PLANS = [
  {
    ...
    aiUnlimited: false,
    features: [
      "إدارة مؤتمتة للرواتب والحضور وملفات الموظفين",
      "تقارير تشخيصية لصحة المنشأة مخصصة حسب القطاع",
      "تحليلات استباقية تكشف اختناقات العمل قبل تفاقمها",
      "تقييم أداء موضوعي بالذكاء الاصطناعي بلا تحيز",
      "مسارات توجيه وخطط علاجية لتطوير أداء الموظفين",
      "دعم فني واحترافي مستمر على مدار الساعة",
      "استيعاب وإدارة بيانات حتى 50 موظف",
    ],
  },
  {
    ...
    features: [
      ...
      "مسارات توجيه وخطط علاجية لتطوير أداء الموظفين",
      "دعم فني واحترافي مستمر على مدار الساعة",
      "استيعاب وإدارة بيانات حتى 100 موظف",
    ],
  },
];
